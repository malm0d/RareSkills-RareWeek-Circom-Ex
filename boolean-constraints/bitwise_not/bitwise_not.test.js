...
describe("BitwiseNot Circuit", function () {
    ...
    before(async function () {
        try {
            ...
            const r1csPath = path.join(__dirname, "bitwise_not_js", "bitwise_not.r1cs");
    ...
    it("Should have sufficient constraints for bitwise NOT logic", async function () {
        // A meaningful circuit should have a larger R1CS file (more than just a few hundred bytes)
        expect(r1csInfo.fileSize).to.be.at.least(1000, "Circuit is underconstrained - needs constraints for bitwise NOT logic");
    });

    it("Should NOT 0000 = 1111", async function () {
        const input = {
            x1: 0, x2: 0, x3: 0, x4: 0,
            z1: 1, z2: 1, z3: 1, z4: 1
        };
    ...
    it("Should NOT 1111 = 0000", async function () {
        const input = {
            x1: 1, x2: 1, x3: 1, x4: 1,
            z1: 0, z2: 0, z3: 0, z4: 0
        };
    ...
    it("Should NOT 1010 = 0101", async function () {
        const input = {
            x1: 1, x2: 0, x3: 1, x4: 0,
            z1: 0, z2: 1, z3: 0, z4: 1
        };
    ...
    it("Should reject incorrect NOT result 1010 != NOT 0101", async function () {
        const input = {
            x1: 1, x2: 0, x3: 1, x4: 0,
            z1: 1, z2: 0, z3: 1, z4: 0  // Wrong result (should be 0101)
        };
        try {
            await witnessCalculator.calculateWitness(input, 0);
            expect.fail("Should have thrown an error for incorrect NOT result");
        } catch (error) {
